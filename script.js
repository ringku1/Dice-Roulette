...
function rollDice() {
  ...
  document.getElementById("result").innerHTML = "You Lose! 😞<br><br>NOW SEE THE CONSEQUENCE...";
    //setTimeout(window.close,4000);
    document.body.classList.add("flicker-effect");
  } else {
    document.getElementById("result").innerHTML = "It's Okay For Now!🏆<br><br>Close Call";
  }
